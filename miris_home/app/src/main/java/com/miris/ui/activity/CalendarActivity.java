...
public class CalendarActivity extends BaseActivity {
    ...
    private void addEvents(CompactCalendarView compactCalendarView) {
        ...
        int[][] holidays = {
                {cal.get(Calendar.YEAR), 0, 1}, // 신정
                {cal.get(Calendar.YEAR), 2, 1}, // 삼일절
                {cal.get(Calendar.YEAR), 4, 5}, // 어린이날
                {cal.get(Calendar.YEAR), 5, 6}, // 현충일
                {cal.get(Calendar.YEAR), 7, 15}, // 광복절
                {cal.get(Calendar.YEAR), 9, 3}, // 개천절
                {cal.get(Calendar.YEAR), 9, 9}, // 한글날
                {cal.get(Calendar.YEAR), 11, 25}, // 성탄절
        };
